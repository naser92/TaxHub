...
{
    public class InvoiceInboxDeleteCommandHandler : CommandHandler, ICommandHandler<InvoiceInboxDeleteCommand>
    {
        private readonly IInvoiceInboxWriteRepository _repository;

        public InvoiceInboxDeleteCommandHandler(IInvoiceInboxWriteRepository repository, IUnitOfWork uow) : base(uow)
        {
        ...
        public async Task<IResult> Handle(InvoiceInboxDeleteCommand command)
        {
