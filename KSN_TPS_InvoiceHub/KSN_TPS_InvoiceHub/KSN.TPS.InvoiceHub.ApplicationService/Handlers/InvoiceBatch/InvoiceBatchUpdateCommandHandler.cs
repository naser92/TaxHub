...
{
    public class InvoiceBatchUpdateCommandHandler : CommandHandler,
        ICommandHandler<InvoiceBatchUpdateCommand>
    {
        private readonly IInvoiceBatchWriteRepository _repository;

        public InvoiceBatchUpdateCommandHandler(
            IInvoiceBatchWriteRepository repository, IUnitOfWork uow) : base(uow)
        {
            _repository = repository;
        }

        public async Task<IResult> Handle(InvoiceBatchUpdateCommand command)
        {
